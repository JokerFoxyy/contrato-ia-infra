...
# ──────────────────────────────────────────────────────────────────────────────
# Subnets — 2 AZs for RDS (requires multi-AZ subnet group)
# ──────────────────────────────────────────────────────────────────────────────
...
# EC2 — permite HTTP (8080), SSH (restrito), e saída livre
resource "aws_security_group" "ec2" {
  ...
  ingress {
    description = "HTTP from anywhere (backend API)"
    from_port   = 8080
    to_port     = 8080
    protocol    = "tcp"
...
# RDS — apenas acessível pela EC2 (mesma VPC)
